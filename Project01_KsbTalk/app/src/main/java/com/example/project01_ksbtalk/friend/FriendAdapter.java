...
import com.example.project01_ksbtalk.databinding.ItemFriendRecvBinding;
import com.example.project01_ksbtalk.opentalk.OpenTalkDTO;
...
public class FriendAdapter extends RecyclerView.Adapter<FriendAdapter.ViewHolder> {
    ...
    // 리사이클러뷰 칸마다의 데이터연결이나 이벤트 연결을 하는 메소드.
    @Override
    public void onBindViewHolder(@NonNull ViewHolder h, int i) {
        ...
        h.binding.lnFriend.setOnClickListener(v -> {
            ...
            intent.putExtra("dto", (CharSequence) list.get(i));
